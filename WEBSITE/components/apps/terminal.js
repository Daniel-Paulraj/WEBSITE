...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["DevOps", "SRE", "Cloud", "Container Orchestration", "Linux", "Application Lifecycle"],    
            interests: ["DevOps", "Deep Learning", "Computer Vision"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">daniel_dev@Dell</div>
